...
$db_connection = mcm_db_or_fail('logged_in');
...
mcm_db_execute($query, "logged_in: listing the user's lists");
...
foreach ($movie_lists as $v) {
	...
	mcm_db_execute($query, 'logged_in: listing the movies in a list');
